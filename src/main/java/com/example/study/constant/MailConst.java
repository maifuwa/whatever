...
public class MailConst {
    ...
    public final static String VERIFY_REGISTER_EMAIL_DATA = "verify:register:email:data";
    public final static String VERIFY_RESET_EMAIL_DATA = "verify:reset:email:data";
